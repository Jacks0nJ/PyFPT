...
This package was originally developed to solve FPT problems in stochastic slow-roll inflation, and as such it also comes with functionality to compare the numerical results with analytical expectations, see :ref:`Analytical Functions<analytics>`.  
