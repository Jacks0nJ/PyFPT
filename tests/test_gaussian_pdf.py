...
from pyfpt.analytics import gaussian_pdf  # noqa: E402
...
class TestGaussianPdf(unittest.TestCase):
    def test_gaussian_pdf(self):
        ...
        def V_ddif(phi):
            V_ddif = (m**2)
            return V_ddif
        func = gaussian_pdf(V, V_dif, V_ddif, phi_i, phi_end)
        ...
        expected = [7.239168, 2290.778447, 15628.9736, 2298.956502, 7.290948]
